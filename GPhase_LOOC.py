...
def Computation(hap_range,haplotypeMatrix, dictAccuracy ) :
    ...
    for value in range(hap_range[0],hap_range[1] ,2):
            ...
            partialSolution = []
            for f, b in zip(haplotypeMatrix[value], haplotypeMatrix[value+1]):
                if str(f)+'|'+str(b) == '0|0':
	    ...
	    posit = []
            ...
            hap1sol = [ haplotypeMatrix[value][i] for i in ambiguousPosition]
            hap2sol = [ haplotypeMatrix[value+1][i] for i in ambiguousPosition]
...
if __name__ == '__main__':
	...
	arg2 = int(sys.argv[2])
        ...
        print "Usage: GPhase_LOOC.py <arg1> <arg2>"
        sys.exit(1)
